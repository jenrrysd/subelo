...
def run_server(port=7080):
    ...
    # Obtener IP local
    try:
        ip_local = subprocess.check_output("hostname -I | awk '{print $1}'", shell=True).decode('utf-8').strip() or "localhost"
    except:
        ip_local = "localhost"
    ...
    while True:
        ...
        if os.path.isdir(ruta):
            ...
            print(f"Error: La ruta '{ruta}' no existe. Por favor ingresa una ruta válida.")
